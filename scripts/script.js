...
function createJourneyStageNode(storyId, storyData, userStoryData, storyIndex, character) {
    ...
    statusIcon.innerHTML = `
        ...
        <svg class="completed-tick-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="display: ${completionStatus === 'completed' ? 'block' : 'none'}">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M12 2.5C6.762 2.5 2.5 6.761 2.5 12C2.5 17.238 6.762 21.5 12 21.5C17.238 21.5 21.5 17.238 21.5 12C21.5 6.761 17.238 2.5 12 2.5Z" fill="#42535F"/>
            <path fill-rule="evenodd" clip-rule="evenodd" d="M15.993 10.2222L11.375 14.8402C11.228 14.9872 11.037 15.0602 10.845 15.0602C10.652 15.0602 10.461 14.9872 10.314 14.8402L8.00503 12.5312C7.71203 12.2382 7.71203 11.7632 8.00503 11.4702C8.29803 11.1772 8.77203 11.1772 9.06503 11.4702L10.845 13.2492L14.932 9.16116C15.225 8.86816 15.7 8.86816 15.993 9.16116C16.286 9.45416 16.286 9.92916 15.993 10.2222Z" fill="#fff"/>
        </svg>
    `;
